...
% Formatting Packages
\usepackage{cite, pdfpages, tikz, pgffor, float, pgfplots, import, xcolor, transparent, siunitx, caption, enumitem, titlesec, multicol, pifont, verbatim, fancyvrb, calc, xspace, subcaption}
